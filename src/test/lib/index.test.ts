...
describe('deepsignal/core', () => {
  ...
  describe('set', () => {
    ...
    it('should update array length', () => {
      const state: Store = { a: 1, nested, array };
  ...
  describe('computations', () => {
    ...
    it('should subscribe correctly from getters', () => {
      let x;
      const store = deepSignal({
        counter: 1,
        get double() {
    ...
    it('should subscribe correctly from getters returning other parts of the store', () => {
      let data;
      const store = deepSignal({
        switch: 'a',
        a: { data: 'a' },
  ...
  describe('refs', () => {
    it('should change if children changed when replaceProxiesInBranchOnChange', async () => {
      ...
      const nop = signalObj.nestedObject.primitive;
  ...
  describe('symbols', () => {
    ...
    it('access Set Symbol.iterator.toString() key path (skip branch)', () => {
      ...
      const iterKey = Symbol.iterator.toString();
  ...
  describe('shallow', () => {
    ...
    it('should stop observing changes in the shallow object if the reference changes and it is not shallow anymore', () => {
      const obj = { a: 1 };
      const shallowObj = shallow(obj);
